...
public final class ToastUtils {
    ...
    public static void showLocationToast(CharSequence text){
        showLocationToast(text, Toast.LENGTH_LONG);
    }
     ...
     * @param duration 显示时长
     */
    private static void showLocationToast(CharSequence text, int duration) {
