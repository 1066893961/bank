package com.bank.manage.application.base;
...
import com.bank.manage.application.BankApplication;
...
import com.bank.manage.application.manager.ActivityCollector;
import com.bank.manage.application.utils.dialog.DialogMaker;
import com.bank.manage.application.views.immersionbarview.ImmersionBar;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected BankApplication mApp;
...
//        TopBarColorManager.setStatusBarMode(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApp = BankApplication.getApplication();
        mActivity = this;
