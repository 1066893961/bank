package com.bank.manage.application.manager;
...
public class RomUtils {
    ...
    public static boolean isLightStatusBarAvailable() {
        if (isMIUIV6ToV9() || isFlymeV4OrAbove() || isAndroidMOrAbove()) {
            return true;
        }
        return false;
    }
    ...
    private static boolean isMIUIV6ToV9() {
        ...
        if (!TextUtils.isEmpty(miuiVersionCodeStr)) {
            try {
                ...
                if (miuiVersionCode >= 4 && miuiVersionCode < 7) {
                    return true;
                }
            } catch (Exception e) {
            }
