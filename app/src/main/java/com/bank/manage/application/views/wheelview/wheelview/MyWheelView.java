package com.bank.manage.application.views.wheelview.wheelview;
...
public class MyWheelView extends View {
	...
	private int wheelBackground = R.drawable.mywheel_bg;
	private int wheelForeground = R.drawable.mywheel_val;
