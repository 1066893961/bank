...
import com.bank.manage.application.utils.Utils;
...
public class BankApplication extends MultiDexApplication {
    private static BankApplication mApplication;
    ...
    public static BankApplication getApplication() {
        return mApplication;
    }
